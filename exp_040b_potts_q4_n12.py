"""
Sprint 040b: q=4 Potts MI-CV at n=12.
n=8 takes ~6.5s/point with chi=15. n=12 with chi=20 should be ~15-20s/point.
Focus on key g values for crossing detection: ordered side, crossing region, disordered side.
"""
...
print("=== Sprint 040b: q=4 Potts MI-CV at n=12 ===\n")
sys.stdout.flush()

results = {'experiment': '040b', 'model': 'q=4 Potts (clock)', 'n': 12, 'chi_max': 20, 'data': {}}

# Key points: ordered (0.8), near-transition (0.95, 1.0, 1.05), disordered (1.1)
g_vals = [0.8, 0.95, 1.0, 1.05, 1.1]
...
for g_J in g_vals:
    ...
    with open('results/sprint_040b_potts_q4_n12.json', 'w') as f:
