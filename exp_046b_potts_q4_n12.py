#!/usr/bin/env python3
"""Sprint 046b: q=4 Potts MI-CV sweep at n=12, chi=20.
...
for g in g_values:
    ...
    with open('results/sprint_046b_q4_n12.json', 'w') as f:
        json.dump({'sprint': '046b', 'q': q, 'n': n, 'chi_max': chi,
                   'data': results_all, 'total_time': time.time()-t_start}, f, indent=2)

t_total = time.time() - t_start
print(f"\nTotal: {t_total:.1f}s")
print("Results saved to results/sprint_046b_q4_n12.json")
