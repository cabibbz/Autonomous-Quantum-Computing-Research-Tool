#!/usr/bin/env python3
"""Sprint 088b: Entanglement spectrum scaling via DMRG at q=2, n=8,12,16,20,24.

q=2 S_q Potts is just the Ising model (c=1/2). Baseline for tail weight scaling.
...
q = 2
gc = 1.0 / q  # g_c = 0.5 for S_q Potts q=2

results = {
    'experiment': '088b_entspec_dmrg_q2',
...
def save():
    with open("results/sprint_088b_entspec_dmrg_q2.json", "w") as f:
...
# q=2 is Ising: c = 1/2 exactly
Re_c = 0.5
results['Re_c'] = Re_c

print(f"Sprint 088b: DMRG entanglement spectrum scaling for S_q Potts q={q}")
print(f"g_c = 1/{q} = {gc:.6f}, c = {Re_c} (exact, Ising)")
print("=" * 70, flush=True)

# q=2, d=2 per site. Extremely fast.
runs = [(8, 30), (12, 40), (16, 60), (20, 80), (24, 100)]
...
save()
print(f"\nSaved to results/sprint_088b_entspec_dmrg_q2.json")
