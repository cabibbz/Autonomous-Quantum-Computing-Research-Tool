#!/usr/bin/env python3
"""Sprint 046a: q=4 Potts MI-CV sweep at n=8, chi=20.

Direct MPS contraction for all-pairs MI. Dense sweep around g_c≈0.893.
g values: 0.70, 0.75, 0.80, 0.85, 0.88, 0.90, 0.93, 0.95, 1.00, 1.05
"""
import numpy as np
...
n = 8
chi = 20
g_values = [0.70, 0.75, 0.80, 0.85, 0.88, 0.90, 0.93, 0.95, 1.00, 1.05]
...
for g in g_values:
    ...
    with open('results/sprint_046a_q4_n8.json', 'w') as f:
        json.dump({'sprint': '046a', 'q': q, 'n': n, 'chi_max': chi,
                   'data': results_all, 'total_time': time.time()-t_start}, f, indent=2)

t_total = time.time() - t_start
print(f"\nTotal: {t_total:.1f}s")
print("Results saved to results/sprint_046a_q4_n8.json")
