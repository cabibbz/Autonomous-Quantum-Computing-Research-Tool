"""
Sprint 041b: q=5 clock MI-CV at n=8 — sweep part 1 (ordered + transition).
...
print("=== Sprint 041b: q=5 Clock MI-CV at n=8 (sweep part 1) ===\n")
sys.stdout.flush()

results = {'experiment': '041b', 'model': 'q=5 clock', 'n': 8, 'chi_max': 15, 'data': {}}
...
for g_J in g_vals:
    ...
    with open('results/sprint_041b_q5_n8_sweep1.json', 'w') as f:
