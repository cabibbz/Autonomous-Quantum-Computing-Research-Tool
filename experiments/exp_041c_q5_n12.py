"""
Sprint 041c: q=5 clock MI-CV at n=12.
q=4 n=12 took ~18s/point. q=5 n=12 will be heavier — try chi=15, max_sweeps=5.
Just 2 key points: ordered (0.8) and near-transition (1.0) to check for crossing.
"""
...
def mi_cv_q5(n, g_J, chi_max=15):
    ...
    eng = dmrg.TwoSiteDMRGEngine(psi, model, {
        ...
        'trunc_params': {'chi_max': chi_max}, 'max_sweeps': 5,
    })
    eng.run()
...
print("=== Sprint 041c: q=5 Clock MI-CV at n=12 ===\n")
sys.stdout.flush()

results = {'experiment': '041c', 'model': 'q=5 clock', 'n': 12, 'chi_max': 15, 'data': {}}
...
for g_J in g_vals:
    ...
    with open('results/sprint_041c_q5_n12.json', 'w') as f:
