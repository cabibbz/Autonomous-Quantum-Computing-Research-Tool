"""
Sprint 040a2: q=4 Potts MI-CV at n=8 — optimized.
Previous attempt: 22s/point with chi=40. Need ~5s/point for reasonable sweep.
Strategy: chi=15, max_sweeps=6, focused g values.
"""
...
print("=== Sprint 040a2: q=4 Potts MI-CV at n=8 (optimized) ===\n")
sys.stdout.flush()

results = {'experiment': '040a2', 'model': 'q=4 Potts (clock)', 'n': 8, 'chi_max': 15, 'data': {}}

# Focus on transition region + endpoints
g_vals = [0.5, 0.8, 0.9, 0.95, 1.0, 1.05, 1.1, 1.3]
...
for g_J in g_vals:
    ...
    with open('results/sprint_040a2_potts_q4_n8.json', 'w') as f:
