"""
Sprint 041b2: q=5 clock MI-CV at n=8 — sweep part 2 (disordered side).
~16.5s/point, budget 3 points in 60s.
"""
...
print("=== Sprint 041b2: q=5 Clock MI-CV at n=8 (sweep part 2) ===\n")
sys.stdout.flush()

results = {'experiment': '041b2', 'model': 'q=5 clock', 'n': 8, 'chi_max': 15, 'data': {}}
...
for g_J in g_vals:
    ...
    with open('results/sprint_041b2_q5_n8_sweep2.json', 'w') as f:
