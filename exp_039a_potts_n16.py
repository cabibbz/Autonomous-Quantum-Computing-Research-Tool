"""
Sprint 039a: Potts q=3 MI-CV at n=16.
Start with timing test at g=1.0, then compute key points near transition.
Need chi_max tuned for speed — d=3 DMRG is ~6x slower than d=2.
"""
...
print("=== Sprint 039a: Potts n=16 MI-CV ===\n")
sys.stdout.flush()

results = {'experiment': '039a', 'model': 'q=3 Potts (clock)', 'n': 16, 'data': {}}

# Key g values: need ordered side, crossing region, disordered side
g_vals = [0.8, 0.9, 0.95, 1.0, 1.05, 1.1]
