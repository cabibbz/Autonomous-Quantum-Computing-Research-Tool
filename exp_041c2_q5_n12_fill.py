"""
Sprint 041c2: q=5 clock MI-CV at n=12 — additional point at g=1.1 (disordered).
"""
...
print("=== Sprint 041c2: q=5 Clock MI-CV at n=12 (fill) ===\n")
sys.stdout.flush()

results = {'experiment': '041c2', 'model': 'q=5 clock', 'n': 12, 'chi_max': 15, 'data': {}}
...
for g_J in g_vals:
    ...
    if elapsed > 50:
        print(f"  TIMEOUT at {elapsed:.0f}s — skipping remaining")
        break
    t1 = time.time()
    try:
    ...
    with open('results/sprint_041c2_q5_n12_fill.json', 'w') as f:
